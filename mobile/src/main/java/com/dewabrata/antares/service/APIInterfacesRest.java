...
public interface APIInterfacesRest {
    ...
    @GET("antares-id/antares_workshop/phsensor/la")
    Call<AntaresDataLast> getLastDataAntares();
/*
    @GET("weather")
...
/*
    ...
    @POST("antares-id/antares_workshop/phsensor/")
    Call<AntaresPostData> postData(@Body String data);
/*
